...
| `FLAVORPRESS_ENCRYPTION_KEY`           | yes in production | AES-GCM key for WordPress Application Passwords and sensitive settings stored in the database. Generate one with `npm run gen-encryption-key`.                                                                                                                                 |
